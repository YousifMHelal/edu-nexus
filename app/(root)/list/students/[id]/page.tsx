      ...
      <div className="w-full xl:w-2/3">
        ...
        <div className="flex flex-col lg:flex-row gap-4">
            ...
            <div className="w-2/3 flex flex-col justify-between gap-4">
              ...
              <div className="flex items-center justify-between gap-2 flex-wrap text-xs font-medium">
                ...
                <div className="w-full md:w-1/3 lg:w-full 2xl:w-1/3 flex items-center gap-2">
                  ...
                  <span className="text-secondary-foreground">+1 234 567</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex-1 flex gap-4 justify-between flex-wrap">
            {/* CARD */}
            <div className="bg-card p-4 rounded-md flex gap-4 w-full md:w-[48%] xl:w-[45%] 2xl:w-[48%]">
              <Image
              ...
              />
              <div className="">
                <h1 className="text-xl font-semibold text-foreground">90%</h1>
            ...
            <div className="bg-card p-4 rounded-md flex gap-4 w-full md:w-[48%] xl:w-[45%] 2xl:w-[48%]">
              ...
              />
              <div className="">
                <h1 className="text-xl font-semibold text-foreground">2</h1>
                <span className="text-sm text-muted">Branches</span>
              </div>
            </div>
            {/* CARD */}
            <div className="bg-card p-4 rounded-md flex gap-4 w-full md:w-[48%] xl:w-[45%] 2xl:w-[48%]">
              ...
              />
              <div className="">
                <h1 className="text-xl font-semibold text-foreground">6</h1>
            ...
            <div className="bg-card p-4 rounded-md flex gap-4 w-full md:w-[48%] xl:w-[45%] 2xl:w-[48%]">
              ...
              <div className="">
                <h1 className="text-xl font-semibold text-foreground">6</h1>
                <span className="text-sm text-muted">Classes</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="w-full xl:w-1/3 flex flex-col gap-4">
        <div className="bg-card p-4 rounded-md">
          ...
          <div className="mt-4 flex gap-4 flex-wrap text-xs text-muted-foreground">
            ...
            <Link className="p-3 rounded-md bg-red-50" href={`/list/teachers/?classId=${2}`}>
              Teacher&apos;s Students
            </Link>
